...
console.log(Secrets.BLOCKFROST_ID_MAINNET);
console.log(Secrets.BLOCKFROST_ID_TESTNET);
const MAINNET = new BlockFrostAPI({
  projectId: "mainnettnOfbMg3Qxr20LnjlWuKeG9SrJkz4mqk",
});

const TESTNET = new BlockFrostAPI({
  projectId: "preprodpuizdyauh6uCZyXfCemuyOy0zKGNS819",
});
