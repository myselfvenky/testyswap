...
import mobileHeroLight from "../assets/img/hero/desktop.jpg";
import mobileHeroDark from "../assets/img/hero/desktop.jpg";
import desktopHeroLight from "../assets/img/hero/desktop.jpg";
import desktopHeroDark from "../assets/img/hero/desktop.jpg";
